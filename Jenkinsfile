pipeline {
    ...
    stages {
        ...
        stage('Quality Scan'){
            steps {
                sh '''
                SonarScanner.MSBuild.exe begin /k:"Mohammed_Eid-dotnet" /d:sonar.host.url="http://54.226.50.200" /d:sonar.login="sqp_f9427808e579878aec930fe023e2d4c868afdcfa"
                MsBuild.exe /t:Rebuild
                SonarScanner.MSBuild.exe end /d:sonar.login="sqp_f9427808e579878aec930fe023e2d4c868afdcfa"
                '''
            }
        }
